...
artwork1 = Artwork.create(name: "Mona Lisa", artist: "Leonardo da Vinci", category: "Renaissance", description: "Average painting, very famous.", location: "Paris", user: user)
...
artwork2 = Artwork.create(name: "The Scream", artist: "Edvard Munch", category: "Expressionist", description: "Scary face.", location: "Oslo", user_id: user.id)
...
artwork3 = Artwork.create!(name: "Campbell's Soup Cans", artist: "Andy Warhol", category: "Modern", description: "Lots of soup.", location: "New York", user_id: user.id)
...
artwork4 = Artwork.create!(name: "Composition with Red Blue and Yellow", artist: "Piet Mondrian", category: "Abstract", description: "Straight lines.", location: "Zurich", user_id: user.id)
...
artwork5 = Artwork.create!(name: "Number 1", artist: "Jackson Pollock", category: "Abstract", description: "Squiggly lines.", location: "LA", user_id: user.id)
